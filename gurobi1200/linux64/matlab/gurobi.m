...
%    information.
%
%    Please consult Variables and Constraints section in the reference
%    manual for a discussion of some of the practical issues associated with
...
%    <a href="matlab:web(fullfile(fileparts(which('gurobi')), 'html', 'index.html'))">included html documentation</a>, and on-line at the <a href="matlab:web('https://docs.gurobi.com/projects/optimizer/en/12.0/reference/matlab.html')">Gurobi Documentation</a> page.
%
